...
export default function SignupRedirect() {
  ...
  useEffect(() => {
    try {
      // Försök omdirigera till den nya registreringssidan med en timeout
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-muted/40 px-4 py-8">
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-muted-foreground mb-4">Vänligen försök gå till registreringssidan manuellt</p>
          <Button
            onClick={() => {
